...
:mod:`ImageLynx.parsers.checks`, which reads it. What is left here is knowledge
...
from ImageLynx.parsers import Schema
from ImageLynx.parsers.checks import CheckReport, check_settings, resolve_existing_path
