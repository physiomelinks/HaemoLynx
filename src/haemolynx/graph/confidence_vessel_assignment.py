...
from ._helpers import sort_nodes as _sort_nodes
from .automated_vessel_assignment import (
    _build_dilation_schedule_microns,
    _dilated_mask_from_cached_distance,
    _distance_from_mask_microns,
    _position_to_mask_index,
...
def assess_large_vessel_assignment_quality(
    ...
    *,
    ...
    terminals = _terminal_nodes_with_position_pairs(G)
    coverage_hits = 0
...
def select_terminal_nodes_from_large_vessel_masks_progressive_dilation_confidence(
    ...
    *,
    ...
    art_distance = _distance_from_mask_microns(base_art, voxel_size_zyx=voxel_size_zyx)
    ven_distance = _distance_from_mask_microns(base_ven, voxel_size_zyx=voxel_size_zyx)
