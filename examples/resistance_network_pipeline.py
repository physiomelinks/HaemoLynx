...
def run_pipeline_stages(settings: dict) -> None:
...
def image_to_model_pipeline(settings: dict | None = None, **overrides) -> None:
    ...
    """
    run_pipeline_stages(resolve_settings(settings, overrides=overrides or None))
